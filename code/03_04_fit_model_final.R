...
# this is the final run of the model using 10,000 paramter combinations using bounds after parameter tuning
...
#for (d in c(1,4,5,12)) {
  ...
  saveRDS(list(out_monthly_all, out_df_top_ten, mean_rmse_df, top_ten_ens, out), file = here("out", "sim_results", paste0(district_name, "_numsim_",num_sim,"_topten_final.RDS")))
